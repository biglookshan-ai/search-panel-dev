...
const I18N = {
  zh: {
    ...
    'ins.overview': '概览', 'ins.searchHistory': '关键词搜索历史', 'ins.topSearches': '关键词搜索统计', 'ins.nav': '分类导航', 'ins.clickHistory': '产品点击历史', 'ins.topClicks': '产品点击统计',
    'ins.searches': '搜索次数', 'ins.zeroKeywords': '零结果关键词', 'ins.drawerClicks': '弹窗点击', 'ins.resultsClicks': '结果页点击', 'ins.recClicks': '推荐位点击', 'ins.sessions': '独立访客',
    'ins.colSearches': '搜索次数', 'ins.colReached': '进入结果页', 'ins.colResults': '结果数',
  ...
  en: {
    ...
    'ins.overview': 'Overview', 'ins.searchHistory': 'Keyword history', 'ins.topSearches': 'Keyword stats', 'ins.nav': 'Category nav', 'ins.clickHistory': 'Click history', 'ins.topClicks': 'Click stats',
    'ins.searches': 'Searches', 'ins.zeroKeywords': 'Zero-result keywords', 'ins.drawerClicks': 'Drawer clicks', 'ins.resultsClicks': 'Results clicks', 'ins.recClicks': 'Recommendation clicks', 'ins.sessions': 'Unique visitors',
    'ins.colSearches': 'Searches', 'ins.colReached': 'Reached results', 'ins.colResults': 'Results',
