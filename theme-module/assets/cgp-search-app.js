...
(function () {
  ...
  function cardHTML(p) {
    ...
    if (CFG.showWishlist || CFG.showAddCart) {
      ...
      if (CFG.showWishlist) {
        h += '<div class="xb-wishlist__btn-custom"><div class="xb-wishlist__add" xb-product-id="' + p.id + '" xb-product-title="' + esc(p.title) + '" xb-product-variant="' + p.sel + '" xb-is-in-stock="true"><button type="button" class="cgp-action-btn" aria-label="Add to wishlist"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></button></div><div class="xb-wishlist__loading" xb-product-id="' + p.id + '">Loading...</div><div class="xb-wishlist__remove" xb-product-id="' + p.id + '"><button type="button" class="cgp-action-btn cgp-action-btn--active" aria-label="Remove from wishlist"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></button></div></div>';
      }
      if (CFG.showAddCart) {
